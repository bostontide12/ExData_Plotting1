plot4 <- function(){
        ...
        ## Generate 4 plots (GAP vs time, VOL vs time, submetering vs time, GRP vs time)
        ...
        par(mfrow=c(2,2))
        plot(TimeDate, HouseholdData$Global_active_power, type="l", xlab="", ylab="Global Active Power")
        plot(TimeDate, HouseholdData$Voltage, type = "l", xlab="datetime", ylab="Voltage")
        plot(TimeDate, HouseholdData$Sub_metering_1, type="l", xlab="", ylab="Energy sub metering")
        ...
        plot(TimeDate, HouseholdData$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
        dev.off()
}